...
def mainflow(ranking_size = 1):
    ...
    print("\n🔍 [Step 1/3] กำลังวิเคราะห์ Asset Selection (Country Level)...")
    ...
    print(f"✅ Step 1 เสร็จสิ้น: ใช้เวลา {step2_duration:.2f} วินาที")

    # --- STEP 3: Sector Selection ---
    print("\n📊 [Step 2/3] กำลังวิเคราะห์ Sector Selection...")
    ...
    print(f"✅ Step 2 เสร็จสิ้น: ใช้เวลา {step3_duration:.2f} วินาที")

    # --- STEP 4: Individual Stock Analysis ---
    print(f"\n💎 [Step 3/3] กำลังวิเคราะห์หุ้นรายตัวในกลุ่ม {passed_sector}...")
    ...
    print("-" * 40)
    print(f"1. Asset Selection    : {step2_duration:>8.2f} วินาที")
    print(f"2. Sector Selection   : {step3_duration:>8.2f} วินาที")
    print(f"3. Stock Analysis     : {step4_duration:>8.2f} วินาที")
    print("-" * 40)
